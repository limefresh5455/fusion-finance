    ...
    subject: "Email From Fusion Finance",
          ...
          <div style="font-family: 'Arial', sans-serif; background-color: #f4f4f9; padding: 30px;">
            <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
              <h2 style="color: #007BFF; text-align: center; margin-bottom: 20px;">🌟 Get In Touch 🌟</h2>
              ...
              <div style="text-align: center; margin-top: 20px;">
                <a href="https://fusion-finance.com" style="text-decoration: none; background-color: #007BFF; color: #fff; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Visit Our Website</a>
              </div>
            </div>
          </div>
        `,
